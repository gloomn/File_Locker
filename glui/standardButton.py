...
def fltButton(target, x, y, width, height, command,  text = "standardButton", backGroundColor = "#4287f5", foreGroundColor = "#000", cursor = "hand2"):
    def on_enter(e):
    ...
    flatButton = Button(master=target,
                        width=width, 
